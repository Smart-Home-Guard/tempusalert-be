...
impl WebTask {
    ...
    pub async fn run(mut self) -> AppResult {
        ...
        let router = self
            ...
            .layer(CorsLayer::new().allow_methods([Method::GET, Method::POST, Method::PATCH, Method::PUT]).allow_credentials(true).allow_origin("http://localhost:3000".parse::<HeaderValue>().unwrap())) // TODO: Whitelist additional origins
            .into_make_service();
